...
const CURVES = {
  nominal: {
    ...
    reading:
      "A curva voltou a apresentar inclinação positiva, mas a maior parte do movimento está concentrada na ponta longa. O mercado exige prêmio crescente para financiar o governo americano em horizontes mais extensos.",
  },
  real: {
    label: "Curva Real - TIPS",
    short: "Real",
    color: "#c49bff",
    unit: "%",
    values: { "2Y": 1.82, "5Y": 1.96, "7Y": 2.07, "10Y": 2.21, "30Y": 2.7 },
    reading:
      "A principal fonte de inclinação da curva americana está nos juros reais. O investidor volta a receber remuneração real significativa sem necessidade de assumir risco corporativo.",
  },
  inflation: {
    label: "Inflação Implícita",
    short: "Implícita",
    color: "#ffae6b",
    unit: "%",
    values: { "2Y": 2.37, "5Y": 2.28, "7Y": 2.27, "10Y": 2.25, "30Y": 2.19 },
    reading:
      "As expectativas de inflação permanecem bem ancoradas. A inflação implícita cai gradualmente ao longo da curva, sugerindo confiança na convergência para níveis próximos da meta do Federal Reserve.",
  },
};
...
const COMPARISON_PERIODS = [
  { key: "current", label: "Atual", opacity: 1, dash: "", width: 3.8, color: null, lightColor: null },
  { key: "1m", label: "1 mês atrás", opacity: 1, dash: "2 6", width: 4, color: "#ffcf6b", lightColor: "#b45309" },
];
...
const DataClient = (() => {
  ...
  const fetchJson = async (path) => {
    ...
    if (contentType && !contentType.includes("json")) throw new Error(`conteúdo inesperado: ${contentType}`);
    ...
    const promise = (async () => {
      ...
      if (!definition) {
        return {
          ...
          error: new Error(`Dataset não registrado: ${id}`),
        };
      }
      ...
      try {
        ...
        if (!definition.validate(data)) throw new Error("estrutura incompatível com o contrato do dataset");
        ...
        return {
          ...
          meta: {
            ...
            issues: newerThanManifest
              ...
              ? [{ severity: "warning", code: "manifest_unavailable", message: `Manifesto indisponível: ${manifestResult.error.message}` }]
              : baseMeta.issues,
...
function curveSourceText(meta) {
  ...
  const componentNote = real2yAsOf && real2yAsOf !== asOf ? `Nominal ate ${asOf}; real 2Y/TIPSPY02 ate ${real2yAsOf}.` : `Dados ate ${asOf}.`;
  const state = meta.datasetStatus && meta.datasetStatus !== "ok"
    ? ` Estado: ${DATASET_STATUS_LABELS[meta.datasetStatus] || meta.datasetStatus}.`
    : "";
  return updatedAt
    ? `${componentNote} Atualizado em ${updatedAt}. Base: ${meta.source || DEFAULT_CURVE_META.source}.${state}`
    : `${componentNote} Base: ${meta.source || DEFAULT_CURVE_META.source}.${state}`;
}
...
const READING_BULLETS = {
  nominal: [
    "Curva voltou a inclinar.",
    "Ponta longa lidera o movimento.",
    "Prêmio de prazo voltou a importar.",
  ],
  real: [
    "Juro real explica a inclinação.",
    "Carry real voltou a ser relevante.",
    "Menos necessidade de risco corporativo.",
  ],
  inflation: [
    "Expectativas seguem ancoradas.",
    "Implícita cai ao longo da curva.",
    "Sem sinal de desancoragem.",
  ],
};
...
const DIAGNOSIS = [
  {
    title: "O problema não é inflação",
    text: "A inflação implícita permanece concentrada entre 2,19% e 2,37%, sem sinais de desancoragem de longo prazo.",
  },
  {
    title: "Juros reais elevados",
    text: "O aumento dos yields nominais é explicado principalmente pela elevação dos juros reais e do prêmio de prazo.",
  },
  {
    title: "Duration exige convicção",
    text: "A maior parte da inclinação está entre 10 e 30 anos, exatamente onde o risco de duration é mais elevado.",
  },
];

const BENEFITS = [
  "Proteção contra inflação realizada.",
  "Juros reais positivos.",
  "Duration reduzida, em torno de 2,3 anos.",
  "Menor volatilidade.",
  "Menor dependência do timing dos cortes do Federal Reserve.",
  "Adaptação natural para investidores acostumados a carrego.",
];

const ALLOCATION_DIAGNOSIS = [
  { title: "Inflação ancorada", text: "A curva não aponta desancoragem." },
  { title: "Juro real elevado", text: "O carry real remunera a espera." },
  { title: "Duration seletiva", text: "A ponta longa exige convicção." },
];

const ALLOCATION_BENEFITS = [
  "Proteção contra inflação realizada.",
  "Juro real positivo no carrego.",
  "Duration moderada (2.3y).",
  "Menor dependência do timing do Fed.",
];
...
function Sp500ValuationContext({ data, relativeData }) {
  ...
  return React.createElement(
    ...
    React.createElement("span", { className: "control-title" }, "Histórico de Forward P/E"),
...
function Sp500PeHistoryChart({ data }) {
  ...
  return React.createElement(
    ...
    React.createElement("span", { className: "control-title" }, "P/E histórico TTM"),
...
const EQUITY_CARDS = [
  ...
  },
  {
    ...
    message: "Comprar S&P 500 hoje também é aceitar concentração.",
  },
  {
...
const MAGNIFICENT_ROWS = [
  ...
  },
  {
    ...
    outlook: "Search, Cloud e Gemini sustentam a tese, apesar de CAPEX alto.",
  ...
  },
  {
    ...
    read: "Um dos melhores perfis: cloud, software recorrente e IA corporativa.",
  },
  {
    company: "Apple",
    pe: "~28x-32x",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("th", null, "Leitura")
            )
          ),
          React.createElement(
            "tbody",
...
function HomeModule({ setActiveModule, theme, setTheme }) {
  return React.createElement(
    ...
    React.createElement("span", { className: "brand-credit" }, "Designed by General Channels Co.")
  );
}
...
function MobileCurveModule({ mode, setMode, theme, curveMeta, fedPolicy }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("div", { className: "control-title" }, "Visão"),
      React.createElement(
        "div",
        {
          className: "segmented",
        ...
        ["nominal", "real", "inflation"].map((key) =>
          React.createElement(
            ...
            key === "inflation" ? "Implícita" : CURVES[key].short
          )
        )
      )
    ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("h2", null, `${current.label} · 5 vértices`),
        React.createElement(
          "ul",
          null,
      ...
      React.createElement(
        "article",
        { className: "panel mobile-summary-card" },
        React.createElement("h2", null, "Fed Funds atual"),
        React.createElement("strong", null, fedPolicy.targetRange.label),
        React.createElement(
          "p",
          null,
          `Faixa definida em ${formatDatePtBr(fedPolicy.targetRange.asOf)}`
        ),
        React.createElement(
          "p",
          null,
          `Probabilidades para a reunião de ${fedPolicy.marketProbability.label.replace(/^até\s+/i, "")} · Dados de ${formatDatePtBr(fedPolicy.marketProbability.asOf)}`
        ),
        React.createElement(
          "div",
          { className: "kpi-probs" },
          React.createElement("div", null, React.createElement("span", null, "Rate hike"), React.createElement("b", null, pctOne(fedPolicy.marketProbability.hike))),
          React.createElement("div", null, React.createElement("span", null, "Steady"), React.createElement("b", null, pctOne(fedPolicy.marketProbability.steady))),
          React.createElement("div", null, React.createElement("span", null, "Rate cut"), React.createElement("b", null, pctOne(fedPolicy.marketProbability.cut)))
        ),
        React.createElement(
          "p",
          { className: "fed-source-note" },
          `Fonte: ${fedPolicy.source || fedPolicy._datasetMeta?.source || "Federal Reserve FOMC statement / Atlanta Fed Market Probability Tracker"} · ${DATASET_STATUS_LABELS[fedPolicy._datasetMeta?.status] || fedPolicy._datasetMeta?.status || "Atual"}`
        )
      )
    )
  );
...
function MobileModuleContent({ activeModule, mode, setMode, theme, curveMeta, fedPolicy }) {
  if (activeModule === "curve") {
    return React.createElement(MobileCurveModule, { mode, setMode, theme, curveMeta, fedPolicy });
  }
...
function MobileDashboard({ activeModule, setActiveModule, theme, setTheme, mode, setMode, curveMeta, fedPolicy }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "button",
          { className: "mobile-icon-btn", type: "button", onClick: () => setTheme(theme === "dark" ? "light" : "dark") },
          theme === "dark" ? "Claro" : "Escuro"
        )
      )
    ),
    mobileModule
      ? React.createElement(
          ...
          React.createElement(MobileModuleContent, { activeModule: selectedModule, mode, setMode, theme, curveMeta, fedPolicy }),
...
function App() {
  ...
  const activeCurves = [mode];
  const kpiCurveKey = mode;
  const kpiCurve = CURVES[kpiCurveKey];
  ...
  return React.createElement(
    "div",
    { className: "app" },
    activeModule === "home" ? null : React.createElement(
      "header",
      { className: "topbar" },
      React.createElement(
        "section",
        ...
        React.createElement("h1", null, moduleCopy.title),
        moduleCopy.lead ? React.createElement("p", { className: "lead" }, moduleCopy.lead) : null
      ),
      React.createElement(
        "aside",
    ...
    activeModule === "home"
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "country-subtabs", "aria-label": "País da curva" },
          React.createElement("button", { type: "button", "aria-pressed": true }, "EUA")
        ),
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            ["nominal", "real", "inflation"].map((key) =>
              React.createElement(
                ...
                key === "inflation" ? "Inflação Implícita" : CURVES[key].short
              )
            )
          )
        ),
        React.createElement(
          "div",
          { className: "control-block" },
          React.createElement("div", { className: "control-title" }, "Comparativo"),
          React.createElement(
            "div",
            {
              className: "segmented curve-view-segmented",
        ...
        React.createElement(
          "div",
          { className: "control-block" },
          React.createElement("div", { className: "control-title" }, "Variação"),
          React.createElement(
            "div",
            {
              className: "segmented curve-view-segmented",
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "article",
            { className: "kpi panel" },
            React.createElement("span", null, "Fed Funds atual"),
            React.createElement("strong", null, fedPolicy.targetRange.label),
            React.createElement(
              "p",
              null,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                null,
                React.createElement("h2", null, `${CURVES[mode].label} · 5 vértices`)
              )
            ),
            React.createElement(
              "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                null,
                React.createElement("span", { className: "control-title" }, "Inclinações"),
                React.createElement("h2", null, "Spreads em bps")
              )
            ),
            React.createElement(
              "div",
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                null,
                React.createElement("span", { className: "control-title" }, "Variação"),
                React.createElement("h2", null, `Atual vs ${DELTA_PERIODS.find((item) => item.key === deltaPeriod)?.label} em bps`)
              )
            ),
            React.createElement(
              "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("h2", null, selected ? `Vértice selecionado: ${selected}` : "Todos os vértices")
              )
            ),
            React.createElement(
              "div",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              null,
              React.createElement("span", { className: "control-title" }, "Diagnóstico"),
              React.createElement("h2", null, "Implicações para alocação")
            )
          ),
          React.createElement(
            "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                null,
                React.createElement("span", { className: "control-title" }, "Conclusão"),
                React.createElement("h2", null, "TIPS de curta duração, 0-5 anos")
              )
            ),
            React.createElement(
              "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "p",
                null,
                "Exemplo ilustrativo. Não constitui recomendação de investimento."
              )
            ),
            React.createElement(
              "div",
              { className: "callout" },
              React.createElement("h3", null, "Por que não duration longa"),
              React.createElement(
                "p",
                null,
                `Treasuries e TIPS longos dependem de compressão relevante dos juros reais. Hoje, o spread 30s10s nominal está em ${bps(nominalLongPremium)} e o real em ${bps(realLongPremium)}, evidenciando prêmio concentrado na ponta longa.`
              )
            )
          )
        )
