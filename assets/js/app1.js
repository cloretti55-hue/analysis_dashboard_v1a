...
function MobileModuleContent({ activeModule, setActiveModule, theme, curvesFed }) {
  ...
  if (activeModule === "etfs") return React.createElement(EtfsModule, { onOpenDataLab: () => setActiveModule("dataLab") });
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("span", null, mobileModule ? "Área" : "Plataforma"),
        React.createElement("strong", null, mobileModule ? MOBILE_MODULES.find(([key]) => key === selectedModule)?.[1] : "Visão geral")
      ),
      React.createElement(
        "div",
    ...
    mobileModule
      ? React.createElement(
          ...
          React.createElement(AnalysisGuide, { compact: true }),
React.createElement(MobileModuleContent, { activeModule: selectedModule, setActiveModule: openModule, theme, curvesFed }),
...
function App() {
  ...
  return React.createElement(
    ...
    activeModule === "home" ? null : React.createElement(AnalysisGuide),
    activeModule === "home"
      ...
      : activeModule === "equity"
        ...
        : activeModule === "tech"
          ...
          : activeModule === "etfs"
            ? React.createElement(EtfsModule, { onOpenDataLab: () => setActiveModule("dataLab") })
