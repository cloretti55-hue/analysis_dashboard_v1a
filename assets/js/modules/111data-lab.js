    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          null,
          React.createElement("span", { className: "control-title" }, "Automated dataset"),
          React.createElement("h2", null, "Monitored ETFs")
        ),
        React.createElement("span", { className: "mini-label" }, data?.asOf ? `Updated ${formatDatePtBr(data.asOf)}` : "JSON")
      ),
      React.createElement(
        "div",
        { className: "dataset-status-stack", "aria-label": "Data Lab provenance" },
        React.createElement(DatasetStatusLine, { result: performanceResult, label: "Primary dataset" }),
        performanceResult?.ok && performanceResult.meta?.status === "ok"
          ? null
          : React.createElement(DatasetStatusLine, { result: fixedIncomeResult, label: "Fixed-income contingency" })
      ),
    ...
    React.createElement(
      ...
      active
        ? React.createElement(
            ...
            React.createElement("p", { className: "data-note" }, `Instrument source: ${active.dataSource || data?.source || "n/a"}.`),
            React.createElement(
              "div",
