...
Status: implementada localmente em 2026-08-04; pendente de publicação e
...
- fonte, data, benchmark, metodologia e freshness visíveis;
- erros reais exibidos sem quebrar os demais módulos.
...
- o Data Lab identifica a base principal e a contingência de renda fixa;
- instrumentos carregados pela contingência preservam origem, data e estado
  `stale` ou `partial`;
- Valuation, curvas, Fed e geografia mostram falhas ou fallbacks sem interromper
  os outros módulos;
...
- o Data Lab sempre informa qual dado foi usado e por quê.
