...
const CORE_FUNCTIONS = [
  { fn: "Beta estrutural EUA", why: "Baixo custo, replicação eficiente e longo prazo.", tickers: ["VOO", "CSPX", "VUAA"], note: "UCITS Acc é uma alternativa offshore não-US; o tratamento fiscal varia por jurisdição." },
  ...
  { fn: "Growth tático / hedge", why: "Opções profundas e liquidez superior.", tickers: ["QQQ"], note: "Instrumento com foco em trading; a eficiência fiscal varia conforme a estrutura." },
  ...
  { fn: "Core global desenvolvido", why: "MSCI World com peso relevante em EUA.", tickers: ["IWDA", "SWDA"], note: "Simplifica a exposição global, mas não reduz o peso dos EUA." },
  ...
  { fn: "Emergentes amplos", why: "Beta EM diversificado.", tickers: ["VWO", "IEMG", "EIMI"], note: "A China pode representar parcela relevante do risco." },
  { fn: "Emergentes ex-China", why: "Reduz risco China.", tickers: ["EMXC", "EXCH"], note: "Usado em estruturas China+1 e de diversificação geopolítica." },
...
const CORE_DETAILS = {
  VOO: ["Beta estrutural EUA", "Carregar S&P 500 com baixo custo.", "Tem menor profundidade para hedge com opções do que SPY.", ["Veículo eficiente para buy and hold.", "Usado quando a estrutura fiscal US-listed é compatível.", "Menos vocacionado a overlays táticos do que SPY."]],
  CSPX: ["Beta estrutural EUA", "S&P 500 UCITS acumulador.", "Tem menor vocação para execução tática e opções.", ["Comum em carteiras offshore não-US.", "Accumulating reduz distribuição de caixa.", "Veículo de carregamento, não de trading."]],
  VUAA: ["Beta estrutural EUA", "S&P 500 UCITS Acc com custo competitivo.", "Menor profundidade tática que SPY.", ["Permite reinvestimento automático.", "O domicílio UCITS altera a estrutura operacional.", "Função principal: core estrutural."]],
  SPY: ["Execução / hedge EUA", "Liquidez, opções e execução tática.", "Tem custo e perfil fiscal diferentes dos veículos UCITS de acumulação.", ["Usado em puts, collars e overlays.", "Profundidade de mercado reduz fricção.", "Instrumento de operação, não necessariamente de carregamento fiscal."]],
  QQQ: ["Growth tático / hedge", "Execução e opções em Nasdaq-100.", "Buy and hold envolve comparação com veículos de menor custo.", ["Alta liquidez intradiária.", "Opções profundas.", "Concentração em growth e tecnologia é parte da exposição."]],
  QQQM: ["Growth estrutural", "Carregar Nasdaq-100 com custo menor.", "Tem menor liquidez para trading intenso do que QQQ.", ["Vocação mais estrutural.", "Mantém exposição growth concentrada.", "Diferença de veículo importa no horizonte longo."]],
  CNDX: ["Growth estrutural", "Nasdaq-100 UCITS Acc.", "Não substitui QQQ em liquidez/opções.", ["Usado por investidores offshore não-US.", "Acumulação facilita reinvestimento.", "Exposição growth com wrapper UCITS."]],
  EQQQ: ["Growth estrutural", "Nasdaq-100 em formato UCITS.", "Distribuição, custo e moeda de negociação variam por listagem.", ["Alternativa europeia para Nasdaq-100.", "Separa exposição e veículo.", "A comparação com CNDX depende de domicílio e política de distribuição."]],
  RSP: ["Redução de concentração", "Equal weight no S&P 500.", "Não representa melhoria automática; altera os fatores de risco.", ["Reduz peso da Magnificent 7.", "Aumenta sensibilidade a mid/large cíclicas.", "Apresenta maior sensibilidade a juros e ciclo doméstico."]],
  VEA: ["Core developed ex-US", "Mercados desenvolvidos fora dos EUA.", "Dilui qualidade/crescimento em relação aos EUA.", ["Diversificação geográfica ampla.", "Exposição a Europa, Japão e Pacífico.", "Pode sobrepor ETFs regionais."]],
  IEFA: ["Core developed ex-US", "Developed ex-US amplo.", "Não resolve sozinho uma composição setorial específica.", ["Alternativa ampla para mercados desenvolvidos.", "Peça de core internacional.", "Tracking, custo e domicílio alteram a comparação."]],
  IWDA: ["Core global desenvolvido", "MSCI World UCITS.", "Inclui EUA e pode gerar sobreposição com S&P 500.", ["Veículo UCITS amplo.", "Simplifica a exposição global.", "Pode sobrepor VOO/CSPX/VUAA."]],
  SWDA: ["Core global desenvolvido", "MSCI World UCITS Acc.", "Não é ex-US; os EUA dominam o índice.", ["Acumulação e ampla diversificação.", "Comum em carteiras offshore simplificadas.", "Mantém concentração relevante nos EUA."]],
  VGK: ["Core Europa", "Beta europeu amplo.", "Europa ampla reúne recortes setoriais distintos.", ["Exposição regional direta.", "Usado para alterar o peso geográfico.", "Não captura isoladamente luxo, defesa e soberania digital."]],
  IEUR: ["Core Europa", "Europa ampla com veículo iShares.", "Custo, domicílio e liquidez alteram a comparação.", ["Peça regional para developed markets.", "Complementa uma exposição global.", "Pode sobrepor VEA/IEFA."]],
  ...
  IMEU: ["Core Europa", "Europa via UCITS.", "Benchmark e política de distribuição variam por veículo.", ["Ferramenta regional para offshore.", "Permite controlar o domicílio do veículo.", "A comparação inclui VGK, IEUR e FEZ."]],
  VWO: ["Emergentes amplos", "Beta emergente diversificado.", "A China pode representar parcela relevante do risco.", ["Exposição ampla a EM.", "Custo competitivo.", "Concentração chinesa e risco geopolítico são limitações relevantes."]],
  IEMG: ["Emergentes amplos", "EM amplo com grande liquidez.", "Não neutraliza China por si só.", ["Inclui large, mid e small em EM.", "Peça de beta emergente.", "A composição regional varia ao longo do tempo."]],
  EIMI: ["Emergentes amplos", "EM UCITS amplo.", "Risco China e tracking são limitações relevantes.", ["Usado em estruturas offshore UCITS.", "Diversificação EM ampla.", "Acc/Dist e moeda variam por listagem."]],
  EMXC: ["Emergentes ex-China", "Exposição China+1 e redução de risco China.", "Não representa o beta EM tradicional completo.", ["Remove o principal risco geopolítico do EM amplo.", "Aumenta peso relativo de Índia, Taiwan e outros.", "Usado como complemento de exposições emergentes."]],
  EXCH: ["Emergentes ex-China", "EM ex-China em wrapper UCITS.", "Liquidez e tracking variam por listagem.", ["Separação geopolítica do beta EM.", "Usado em carteiras offshore.", "Complementa VWO/IEMG/EIMI."]],
  IB01: ["Liquidez USD", "iShares $ Treasury Bond 0-1yr UCITS ETF USD Acc.", "Caixa remunerado em dólar, não exposição relevante à duration.", ["Usado como liquidez remunerada.", "Baixa volatilidade e baixa sensibilidade a juros.", "O formato Acc reinveste os rendimentos."]],
  IBTA: ["Duration curta", "iShares $ Treasury Bond 1-3yr UCITS ETF USD Acc.", "Baixa sensibilidade a juros.", ["Adiciona um pouco mais de duration que caixa.", "Combina carrego com duration curta.", "Representa o primeiro trecho após a liquidez."]],
  CBU7: ["Duration média curta", "iShares $ Treasury Bond 3-7yr UCITS ETF USD Acc.", "Miolo curto da curva.", ["Equilibra carrego e risco de duration.", "Apresenta sensibilidade moderada a cortes de juros.", "Vértice intermediário em uma escada de Treasuries."]],
  IBTM: ["Duration média", "iShares $ Treasury Bond 7-10yr UCITS ETF USD Acc.", "Hedge parcial contra queda de juros.", ["Mais sensível ao ciclo de política monetária.", "Ganha valor quando os juros desse trecho caem, mantidas as demais condições.", "Apresenta mais sensibilidade do que os vértices curtos."]],
  ...
  TIP5: ["Inflação curta", "iShares $ TIPS 0-5 UCITS ETF USD Acc.", "Proteção inflacionária com duration menor.", ["Combina juro real positivo com menor duration.", "Tem perfil de carrego real com menor sensibilidade a juros longos.", "Separa exposição à inflação e duration longa."]],
  ITPS: ["Inflação ampla", "iShares $ TIPS UCITS ETF Acc.", "Inflação americana com mais duration.", ["Oferece exposição à inflação realizada em uma cesta mais ampla.", "Traz mais sensibilidade a juros reais.", "Aparece em carteiras com maior tolerância a duration."]],
  ITPE: ["Inflação ampla", "iShares $ TIPS UCITS ETF Acc.", "Inflação americana com mais duration.", ["Alternativa para exposição ampla a TIPS.", "Bolsa, listagem e política operacional diferenciam o veículo.", "Custo, tracking e moeda de negociação alteram o resultado."]],
  ...
  IHYA: ["High Yield USD", "iShares $ High Yield Corp Bond UCITS ETF USD Acc.", "Crédito mais arriscado e yield maior.", ["Carrega mais spread e mais risco de default.", "Tende a responder positivamente quando crédito e ciclo estão construtivos.", "Não costuma ser tratado como renda fixa defensiva."]],
  AGGU: ["Core bond global", "iShares Core Global Aggregate Bond UCITS ETF USD Acc.", "Diversificação global em bonds.", ["Combina governos e crédito global.", "Funciona como exposição ampla de renda fixa.", "Hedge cambial, duration e composição mudam a leitura como core."]],
  GLD: ["Hedge macro", "SPDR Gold Shares.", "ETF de ouro físico com alta liquidez.", ["Funciona como ativo real/monetário.", "Pode reagir a choques de confiança e regimes adversos.", "É mais usado quando liquidez e profundidade importam."]],
  IAU: ["Hedge macro", "iShares Gold Trust.", "ETF de ouro físico com custo competitivo.", ["Oferece exposição física a ouro com custo competitivo.", "É usado como diversificador macro de longo prazo.", "Tem menor foco em trading intenso do que GLD."]],
  "FXF / CHF": ["Hedge macro", "Invesco CurrencyShares Swiss Franc Trust.", "Exposição ao franco suíço contra o dólar.", ["Refúgio histórico em choques de confiança.", "Baixo carrego, liquidez menor que grandes ETFs e risco de intervenção do SNB.", "Na leitura de regime, dólar, franco suíço e ouro respondem a riscos diferentes."]],
};
...
const SATELLITES = [
  ...
  },
  {
    ...
    points: ["Apresenta perfil historicamente mais defensivo.", "O risco de duration altera a resposta a juros.", "ETF amplo mistura perfil defensivo com sensibilidade a juros."],
  },
  {
  ...
  },
  {
    ...
    points: ["Demografia cria vento estrutural.", "Oferta cresce devagar por mão de obra e regulação.", "Cesta pequena reduz a diluição de um ETF genérico."],
  },
  {
  ...
  },
  {
    ...
    points: ["A análise separa automação, transporte, aço e bens de capital.", "ETF amplo tende a olhar indústria passada, não necessariamente CAPEX futuro.", "Cesta apresenta maior aderência ao recorte temático."],
  },
  {
...
function SatelliteModule() {
  ...
  return React.createElement(
    ...
    React.createElement(
      "article",
      { className: "panel" },
      React.createElement("div", { className: "section-head" }, React.createElement("div", null, React.createElement("span", { className: "control-title" }, "Interpretação · Satélites temáticos"))),
      React.createElement(
        "div",
...
const EUROPE_THEMES = [
  ...
  },
  {
    ...
    points: ["Mais controle de dados do que crescimento explosivo.", "Regulação sustenta demanda.", "Cesta reduz a dependência de um único nome."],
  },
  {
    ...
    points: ["LUXU/GLUX dão exposição simples.", "ETF oferece exposição ao setor; a cesta concentra marcas específicas.", "Cesta separa líderes de marcas frágeis."],
  },
  {
  ...
  },
  {
    ...
    points: ["Conversa com IA, energia e data centers.", "ETF industrial amplo dilui qualidade.", "Cesta concentra equipamentos e automação."],
  },
  {
    ...
    points: ["ASML é difícil de replicar.", "Exposição concentrada em poucos nomes.", "Cesta reduz diluição."],
  },
];
...
const CHINA_CHANNELS = [
  {
    ...
    reading: "Exposição direta e risco elevado; o resultado varia conforme o segmento escolhido.",
    points: ["MCHI cobre China ampla.", "FXI concentra large caps/Hong Kong.", "KWEB cobre internet chinesa.", "ASHR/KBA cobrem A-shares onshore."],
  ...
  },
  {
    ...
    captures: "Consumidor chinês premium e demanda asiática sem exposição direta à bolsa chinesa.",
  ...
  },
  {
    ...
    reading: "Reduz a concentração em uma única cadeia sem eliminar a relação econômica com a China.",
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("div", null, React.createElement("span", { className: "control-title" }, "Interpretação · Matriz de exposição"), React.createElement("h2", null, "Direta, indireta ou substituição parcial"))
      ),
      React.createElement(
        "div",
        { className: "satellite-filters" },
    ...
    React.createElement(
      ...
      React.createElement("ul", { className: "satellite-list" }, active.points.map((point) => React.createElement("li", { key: point }, point))),
      React.createElement("div", { className: "detail-box proxy-box" }, React.createElement("span", null, "Exemplos"), React.createElement("strong", null, active.names.join(" · "))),
      React.createElement("p", { className: "data-note" }, "Base: exemplos de canais e instrumentos, junho/2026. A composição atual está disponível no provedor.")
    )
  );
}
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { className: "section-head" },
        React.createElement("div", null, React.createElement("span", { className: "control-title" }, "Interpretação · Estratégias de hedge"), React.createElement("h2", null, "Payoff, beta, volatilidade e moeda"))
      ),
      React.createElement(
        "div",
        { className: "satellite-filters" },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "article",
        { className: "panel" },
        React.createElement("div", { className: "section-head" }, React.createElement("div", null, React.createElement("span", { className: "control-title" }, "Interpretação · Matriz de instrumentos"))),
        React.createElement(
          "div",
...
const SECTOR_GICS_ETFS = [
  ...
  { ticker: "XLI", sector: "Industrials", icon: "factory", tone: "sat-risk-medium", role: "Ciclo / CAPEX", why: "Indústria, transporte, defesa, máquinas e infraestrutura.", limit: "ETF amplo dilui recortes específicos como defesa ou reindustrialização.", points: ["Bloco amplo de ciclo físico e CAPEX.", "Conversa com onshoring e infraestrutura.", "Uma cesta representa um recorte mais específico."] },
  ...
  { ticker: "XLRE", sector: "Real Estate", icon: "home", tone: "sat-risk-defensive", role: "Imobiliário listado", why: "REITs e ativos imobiliários listados.", limit: "Sensível a juros, crédito, cap rates e vacância.", points: ["Oferece exposição imobiliária líquida.", "Mais duration e crédito do que growth.", "Não substitui real estate privado."] },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { className: "section-head" },
        React.createElement("div", null, React.createElement("span", { className: "control-title" }, "Fato e interpretação · Setores GICS / S&P 500"))
      ),
      React.createElement(
        "div",
        { className: "risk-legend" },
...
function EtfsModule({ onOpenDataLab } = {}) {
  ...
  return React.createElement(
    ...
    onOpenDataLab
      ? React.createElement(
          "section",
          { className: "panel module-context-link" },
          React.createElement(
            "div",
            null,
            React.createElement("span", { className: "control-title" }, "Cálculo"),
            React.createElement("strong", null, "Compare retorno e risco no Data Lab"),
            React.createElement("p", null, "A área de Instrumentos descreve função e limitações; o Data Lab reúne as métricas quantitativas disponíveis.")
          ),
          React.createElement("button", { type: "button", onClick: onOpenDataLab }, "Abrir Data Lab")
        )
      : null,
    React.createElement(
      "nav",
      { className: "panel etf-subtabs", "aria-label": "Subáreas de instrumentos" },
