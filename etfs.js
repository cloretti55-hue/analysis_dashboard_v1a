...
function FixedIncomeModule({ dataLabTickers, initialEtf = "IB01" }) {
  return React.createElement(CoreModule, { functions: FIXED_INCOME_FUNCTIONS, initialEtf, legendMode: "fixed", showUcitsToggle: false, dataLabTickers });
}
...
SECTOR_GICS_ETFS.forEach((item) => registerEtfDestination(item.ticker, "sectors", item.ticker));
