...
const THEME_BRIEFINGS = [
  {
    ...
    summary: "Gold as a monetary reserve, central banks as a source of structural demand, investors as the marginal driver and commodities with different economic functions.",
